 ...
 */
public class MoneyAmountAndCurrencyType implements CompositeUserType<MonetaryAmount> {
    public static class MoneyAmountAndCurrencyMapper {
        BigDecimal amount;
        String currency;
    }

    public MoneyAmountAndCurrencyType() {
    }
    ...
    public Class<?> embeddable() {
        return MoneyAmountAndCurrencyMapper.class;
    }
