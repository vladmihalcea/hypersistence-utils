 ...
 */
public class PostgreSQLJsonPolymorphicMapNotSerializableTest extends AbstractPostgreSQLIntegrationTest {
    ...
    public static class Book {
        ...
        public Map<String, DiscountCoupon> getCoupons() {
            return coupons;
        }

        public Book setCoupons(Map<String, DiscountCoupon> coupons) {
            this.coupons = coupons;
            return this;
        }

        public Book addCoupon(String code, DiscountCoupon topic) {
