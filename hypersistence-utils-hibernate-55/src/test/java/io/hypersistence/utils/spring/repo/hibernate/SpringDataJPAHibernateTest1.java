...
public class SpringDataJPAHibernateTest1 {
    ...
    public void testSave() {
        Map<String, Publisher> bookDetails = SharedDomainSharedDataFixture.standardBook();
        ...
        for (Books book : books) {
            ...
            assertEquals(Optional.ofNullable(0L), Optional.ofNullable(book.getVersion()));
        }
    }
