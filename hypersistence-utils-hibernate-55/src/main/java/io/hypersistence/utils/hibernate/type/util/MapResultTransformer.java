...
/**
 * The {@link io.hypersistence.utils.hibernate.type.util.MapResultTransformer} allows us to return
 ...
 *
 * @deprecated use {@link io.hypersistence.utils.hibernate.query.MapResultTransformer} instead
 *
 * @author Vlad Mihalcea
 * @since 2.9.0
 */
@Deprecated
public class MapResultTransformer<K, V> extends io.hypersistence.utils.hibernate.query.MapResultTransformer {
