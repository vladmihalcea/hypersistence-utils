 ...
 */
public class PostgreSQLCurrencyTypeTest extends AbstractPostgreSQLIntegrationTest {
    @Override
    ...
    @Entity(name = "Order")
    @Table(name = "orders")
    @TypeDef(typeClass = CurrencyType.class, defaultForType = CurrencyUnit.class)
