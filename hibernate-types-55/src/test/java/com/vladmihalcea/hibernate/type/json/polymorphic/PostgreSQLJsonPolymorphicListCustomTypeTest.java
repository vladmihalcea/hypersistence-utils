...
import com.vladmihalcea.hibernate.type.json.configuration.CustomObjectMapperSupplier;
import com.vladmihalcea.hibernate.type.json.configuration.PostgreSQLJsonBinaryTypeProgrammaticConfigurationTest;
...
public class PostgreSQLJsonPolymorphicListCustomTypeTest extends AbstractPostgreSQLIntegrationTest {
    ...
    public void test() {
        ...
        Timestamp validUntil = java.sql.Timestamp.valueOf(LocalDateTime.now().plusDays(10));
